...
class VisualFrames_FeaturedProducts_Block_Adminhtml_FeaturedProducts_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  */
	  ...
	  $this->addColumn('created_time', array(
			'header'    => Mage::helper('featuredproducts')->__('Creation Time'),
			'align'     => 'left',
			'width'     => '120px',
			'type'      => 'date',
			'default'   => '--',
	  ...
	  $this->addColumn('update_time', array(
			'header'    => Mage::helper('featuredproducts')->__('Update Time'),
			'align'     => 'left',
			'width'     => '120px',
			'type'      => 'date',
			'default'   => '--',
